        		...
        		<div class="meta-info">
        			<?php 
                        if( ( isset( $meta['trip_duration'] ) && '' != $meta['trip_duration'] ) || ( isset( $meta['trip_duration_nights'] ) ) && '' != $meta['trip_duration_nights'] ){
                            ...
                            if( isset( $meta['trip_duration'] ) ) printf( esc_html__( '%s Days', 'travel-agency' ), absint( $meta['trip_duration'] ) ); 
                            if( isset( $meta['trip_duration_nights'] ) ) printf( esc_html__( ' - %s Nights', 'travel-agency' ), absint( $meta['trip_duration_nights'] ) ); ;
                            echo '</span>';                                   
                        }  
                    ?>                        
        		</div>
